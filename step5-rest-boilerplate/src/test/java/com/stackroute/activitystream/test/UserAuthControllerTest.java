...
public class UserAuthControllerTest {
	...
	public void testAuthenticate() throws Exception {
		...
		mockMvc.perform(post("/api/authenticate").contentType(MediaType.APPLICATION_JSON).content(asJsonString(user)))
	...
	public void testLogout() throws Exception {
		...
		mockMvc.perform(put("/api/logout").session((MockHttpSession) session)).andExpect(status().isOk());
	...
	public void testLogoutFailure() throws Exception {
		...
		mockMvc.perform(put("/api/logout")).andExpect(status().isBadRequest());
