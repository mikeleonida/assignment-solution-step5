...
public interface UserCircleRepository extends CrudRepository<UserCircle, Integer> {
	...
	/*
	 * This method will retrieve an UserCircle object from database which is
	 * matching the username and circleName
	 * 
	 * Write a query to get user circle object object from Database useing username
	 * and circlename.
	 * 
	 */
	@Query
